    ...
    <div className="container-narrow">
      ...
      <div className="row">
        <div className="col-md-6" data-aos="zoom-in" data-aos-delay={100}>
          <div className="bg-light my-2 p-3 pt-2"><form action="https://formspree.io/your@email.com" method="POST">
              ...
              <div className="form-group my-2">
                ...
                <textarea className="form-control" style={{resize: 'none'}} id="message" name="message" rows={4} required defaultValue={""} />
              </div>
        ...
        <div className="col-md-6" data-aos="fade-left" data-aos-delay={300}>
          <div className="mt-3 px-1">
            ...
            <p>If you like wanna know my self then drop me a message using the contact form. </p>
            <p>See you!</p>
          </div>
